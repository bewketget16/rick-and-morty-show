<template>
  <div class="container mx-auto flex flex-wrap justify-center bg-sky-950 py-8">
    <div
      class="text-5xl w-full text-gray-300 mb-8 font-semibold ml-6 mt-8"
      id="episode"
    >
      Episodes
    </div>
    ...
    <div
      ...
      class="grid grid-cols-1 gap-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 ml-6 mr-6"
    >
      <div
        v-for="(episode, index) in episodes"
        :key="episode.id"
        class="border border-gray-500 rounded-lg overflow-hidden shadow-md mx-4 mb-4"
      >
