<template>
  <div class="container mx-auto flex flex-wrap justify-center bg-sky-950">
    <div class="container mx-auto flex flex-wrap justify-center">
      <div
        class="text-5xl w-full text-gray-300 font-semibold mb-4 ml-6 mt-8"
        id="character"
      >
        Characters
      </div>
    ...
    <div
      ...
      class="grid grid-cols-1 gap-1 lg:grid-cols-5 md:grid-cols-3 sm:grid-cols-2 mr-6 ml-6"
    >
      <div
        v-for="(item, index) in characters"
        :key="index"
        class="border border-gray-500 rounded-2xl overflow-hidden shadow-md mx-4 mb-4"
      >
