  ...
  <div class="flex flex-col min-h-screen bg-sky-950">
    ...
    <div class="container mx-auto mt-8 flex-grow">
      ...
      <div v-else-if="episode" class="mt-8">
        <h2 class="text-3xl font-semibold text-white">Episode Name:{{ episode.name }}</h2>
        ...
        <hr class="my-4" />
        <!-- Characters List -->
        <h3 class="text-xl font-semibold mt-4 text-gray-400">Characters in this Episode</h3>
        <div
